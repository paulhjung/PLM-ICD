...
def parse_args():
    ...
    parser.add_argument("--validation_file", type=str, default="../data/mimic4/CHSmimic4icd10test21-1120_nodigitsTrue_nofirstwordsTrue_1024.csv", help="A csv or a json file containing the validation data.")
    parser.add_argument("--output_dir", type=str, default="../models/data_maxedat1024") #1024-10epochs-32batch", help="Where to store the final model.")
    ...
    parser.add_argument("--model_name_or_path", type=str, default="../models/nodigitsTrue-1024-4epochs-32batch-dev", help="Path to pretrained model or model identifier from huggingface.co/models.")
