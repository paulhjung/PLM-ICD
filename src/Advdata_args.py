...
def parse_args():
    ...
    parser.add_argument("--validation_file", type=str, default="../data/mimic4/Advdata_wordlim10001.csv", help="Title prefix of csv or a json file containing the validation data.")
