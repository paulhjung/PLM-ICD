...
def parse_args():
    ...
    parser.add_argument("--validation_file", type=str, default="../data/mimic4/CHSmimic4icd10test21-1130_nodigitsTrue_nofirstwordsTrue_2048.csv", help="A csv or a json file containing the validation data.")
    parser.add_argument("--output_dir", type=str, default="../models/top9_data_maxed_at2048") #1024-10epochs-32batch", help="Where to store the final model.")
    ...
    parser.add_argument("--code_file", type=str, default="../data/mimic4/top9codes.txt", help="A txt file containing all codes.")
