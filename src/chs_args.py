...
def parse_args():
    ...
    parser.add_argument("--validation_file", type=str, default="../data/mimic4/CHSmimic4icd10test20-1142.csv", help="A csv or a json file containing the validation data.")
