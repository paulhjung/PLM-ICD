...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="../models/nodigitsTrue-1024-4epochs-32batch-dev") #1024-10epochs-32batch", help="Where to store the final model.")
