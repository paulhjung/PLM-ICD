...
def parse_args():
    ...
    parser.add_argument("--validation_file", type=str, default="../data/mimic4/CHSmimic4icd10test21-1130_nodigitsTrue_nofirstwordsTrue2048.csv", help="A csv or a json file containing the validation data.")
    parser.add_argument("--output_dir", type=str, default="../models/top3_datamax2048limit1792") #1024-10epochs-32batch", help="Where to store the final model.")
    parser.add_argument("--max_length", type=int, default=1792, help="The maximum total input sequence length after tokenization. Seq longer than this are truncated, seq shorter are padded if `--pad_to_max_lengh` is passed.")
    ...
    parser.add_argument("--code_file", type=str, default="../data/mimic4/top3codes.txt", help="A txt file containing all codes.")
    ...
    parser.add_argument("--num_warmup_steps", type=int, default=1600, help="Number of steps for the warmup in the lr scheduler.")
