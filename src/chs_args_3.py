...
def parse_args():
    ...
    parser.add_argument("--validation_file", type=str, default="../data/mimic4/CHSmimic4icd10test31-1712_nodigitsTrue_nofirstwordsTrue_1856.csv", help="A csv or a json file containing the validation data.")
    parser.add_argument("--output_dir", type=str, default="../models/top3_max1792") #1024-10epochs-32batch", help="Where to store the final model.")
