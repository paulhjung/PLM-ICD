...
def parse_args():
    ...
    parser.add_argument("--code_file", type=str, default="../data/mimic4/top23_3digits.txt", help="A txt file containing all codes.")
    parser.add_argument("--num_codes", type=str, default=23, help="Number of all codes.")
