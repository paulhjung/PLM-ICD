...
from chs_args_3 import parse_args
...
def main():
    ...
    if args.devmode:
        ...
        data_files["train"+str(0)] = args.train_file+str(0)+f"_nodigits{args.remove_digits}_nofirstwords{args.remove_firstwords}_{args.max_length}.csv"
    elif args.train_file is not None:
        for i in range(9):
            logger.info(f"Loading {i}")
            data_files["train"+str(i)] = args.train_file+str(i)+f"_nodigits{args.remove_digits}_nofirstwords{args.remove_firstwords}_{args.max_length}.csv"
    ...
    save_path = DIRECTORY_PLM + f'tokensdata_nodigits{args.remove_digits}_noFW{args.remove_firstwords}_{args.max_length}_top3'
