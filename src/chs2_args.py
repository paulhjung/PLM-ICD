...
def parse_args():
    ...
    parser.add_argument("--maxtoken_length", type=int, default=1024, help="The maximum total input sequence length after tokenization. Seq longer than this are truncated, seq shorter are padded if `--pad_to_max_lengh` is passed.")
    ...
    parser.add_argument("--num_codes", type=str, default=3, help="Number of all codes.")
